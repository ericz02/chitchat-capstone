  ...
  async up(queryInterface, Sequelize) {
    ...
    await queryInterface.bulkInsert("comments", [
      ...
      },
      {
        ...
        CommentableId: 6,
        commentableType: "comment",
        content: "Iced Coffee less sugar!",
        createdAt: new Date(),
        updatedAt: new Date(),
      },
      {
        ...
        CommentableId: 2,
        commentableType: "post",
        content: "What do you think about Starbucks or Tim Hortons?",
        createdAt: new Date(),
        updatedAt: new Date(),
      },
      {
        ...
        commentableType: "comment",
        content:
          "Starbucks is pretty good, Tim Hortons is not bad, Dunkin is probably in the middle",
        createdAt: new Date(),
        updatedAt: new Date(),
      },
      {
        ...
        CommentableId: 9,
        commentableType: "comment",
        content: "Starbucks is alright. Tim Hortons is alright.",
        createdAt: new Date(),
        updatedAt: new Date(),
      },
      {
        ...
        CommentableId: 8,
        commentableType: "comment",
        content: "Starbucks is overrated",
        createdAt: new Date(),
        updatedAt: new Date(),
      },
    ]);
