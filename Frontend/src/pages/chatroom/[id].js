          ...
          <div className=" p-4  flex-row items-center">
            {postLength > 0 ? (
              posts.map((post) => (
                <div
                  key={post.id}
                  className=" bg-zinc-100 rounded-md shadow-md  cursor-pointer border-black border-2 my-6 mx-6 p-4 hover:scale-105 hover:ease-in duration-100"
                >
                  ...
                  <Link href={`/post/${post.id}`}>
                    <div className="	bg-cyan-50	 p-3 m-2 rounded-md hover:skew-x-2 border border-gray-700">
