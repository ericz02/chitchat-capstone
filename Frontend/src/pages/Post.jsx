...
const Post = () => {
  return (
    <div className="bg-[#FFFFFF] p-4 flex flex-col justify-center ml-64 mt-20">
      <h1 className="flex justify-center text-2xl font-bold mb-4 mt-3">Create a New Post</h1>
      ...
      <button
        className="bg-[#14AE5C] hover:bg-[#0F8B49] text-white font-bold py-2 px-4 rounded mx-auto w-1/6 ml-[835px]"
      >
        Submit Post
      </button>
    </div>
