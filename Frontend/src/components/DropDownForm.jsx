...
const DropdownForm = ({ darkMode, setDarkMode }) => {
    ...
    const handleDarkModeToggle = () => {
      setDarkMode((prevDarkMode) => !prevDarkMode); //could just do !darkMode instead, more readable.
    };
    ...
    //this is what changes the background everytime the darkMode dependency changes.
